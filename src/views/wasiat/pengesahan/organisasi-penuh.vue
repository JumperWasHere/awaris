      ...
      >
        ...
        <div class="card-body">
          <h5 class="text-center">
            PENGESAHAN PENDAFTARAN PENUH: BANK SENDIRIAN BERHAD
          </h5>
          <div class="row mt-2">
            <div
              class="col-lg-3 col-md-5 mt-4 mt-sm-0 pt-2 pt-sm-0 card border-0"
            >
              <div class="form custom-form">
                <div class="form-group mb-0">
                  <label>Kad Pengenalan Baru:</label>
                </div>
              </div>
            </div>
            <div
              class="col-lg-4 col-md-5 mt-4 mt-sm-0 pt-2 pt-sm-0 card border-0"
            >
              <div class="form custom-form">
                <div class="form-group mb-0">
                  <input
                    type="text"
                    class="form-control"
                    placeholder="Kad Pengenalan Baru"
                    name
                    required
                  />
                </div>
          ...
          <div class="row mt-2">
            ...
            >
              <div class="form custom-form">
                <div class="form-group mb-0">
                  <label
                    >Kad Pengenalan Lama / Polis / Tentera / Passport:</label
                  >
                </div>
              </div>
            </div>
              ...
              <div class="form custom-form">
                <div class="form-group mb-0">
                  <input
                    type="text"
                    class="form-control"
                    placeholder="Kad Pengenalan Lama / Polis / Tentera / Passport"
                    name
                    required
                  />
                </div>
            ...
            >
              <div class="form custom-form">
                <div class="form-group mb-0 text-right">
                  <router-link
                    to="/wasiat/pengesahan/pendaftaran-penuh"
                    class="btn btn-outline-primary mr-2"
                  >
                    <i class="mdi mdi-arrow-left"></i> Senarai Pengesahan
                  </router-link>
                </div>
              </div>
            </div>
            ...
            <table class="table mb-0 table-center" style="font-size: 12px">
              <thead class="bg-light">
                <tr>
                  ...
                  <th>Tarikh Daftar</th>
                  <th>Nama Pewasiat</th>
                  <th>No. KP Baru / Lama / Polis / Tentera / Passport</th>
                  <th>Negeri</th>
                  <th>Cawangan</th>
                  <th>Nama Ejen</th>
                  <th>Telefon Ejen</th>
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td>15-01-2020</td>
                  <td>MOHD SYABIL FUADDY</td>
                  <td>565656565656</td>
                  <td>SELANGOR</td>
                  <td>HQ</td>
                  <td>SITI BINTI SEMAN</td>
                  <td>60133780755</td>
                  <td>
                    <router-link
                      to="/"
