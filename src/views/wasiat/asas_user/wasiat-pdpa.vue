              ...
              <form class="login-form">
                <div class="card card-custom gutter-b">
                  ...
                  <div class="card-body">
                    <p class="text-justify">
                      ...
                      Berhad untuk memberikan perkhidmatan yang bersesuaian
                      dengan anda. Maklumat peribadi yang diberikan oleh anda
                      akan digunakan untuk pentadbiran dan pengurusan
                      perkhidmatan yang diberikan kepada anda. Maklumat peribadi
                      anda boleh digunakan untuk memberi anda maklumat lanjut
                      mengenai produk dan perkhidmatan yang bersesuaian dengan
                      anda daripada Amanah Warisan Berhad. Maklumat tersebut
                      adalah sulit dan persendirian dan tidak akan dikemukakan
                      oleh pihak ketiga tanpa kebenaran anda. Semua maklumat
                      yang diberikan oleh anda dalam borang ini adalah tepat,
                      lengkap dan terkini. Jika anda ingin mengemaskini maklumat
                      peribadi anda, sila hubungi kami di talian 03-62639990,
                      e-mel kami di: admin@awarisgroup.com.
                    </p>
                ...
                <div class="card card-custom gutter-b">
                  ...
                  <div class="card-body">
                    ...
                    <p>
                      1. Melantik AMANAH WARISAN BERHAD sebagai Wasi dan
                      Pemegang Amanah bagi wasiat saya dengan kadar fi
                      pelaksanaan sebanyak 2% daripada jumlah keseluruhan harta
                      Pusaka saya.
                    </p>
                    <p>
