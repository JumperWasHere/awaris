        ...
        >
          <ul class="nav nav-tabs">
            <li class="nav-item">
              <router-link
                :class="
                  this.$route.name == 'trust.pengesahan.pendaftaran'
                    ? 'active'
                    : ''
                "
                class="nav-link"
                ...
                >Pengesahan Permohonan Hibah
              </router-link>
            </li>
            <li class="nav-item">
              <router-link
                :class="
                  this.$route.name == 'trust.pengesahan.pendaftaran-saksi'
                    ? 'active'
                    : ''
                "
                class="nav-link"
                ...
                >Pengesahan Saksi Hibah</router-link
              >
            </li>
          </ul>
          <div class="card-body">
