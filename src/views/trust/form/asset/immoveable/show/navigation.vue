            ...
            <ul class="nav nav-tabs mt-4">
              <li class="nav-item">
                <router-link
                  class="nav-link"
                  :class="
                    routeName == 'trust.immoveable-property.details'
                      ? 'active'
                      : ''
                  "
                  :to="{
              ...
              <li class="nav-item">
                <router-link
                  class="nav-link"
                  :class="
                    routeName == 'trust.immoveable-property.receiver'
                      ? 'active'
                      : ''
                  "
                  :to="{
              ...
              <li class="nav-item">
                <router-link
                  class="nav-link"
                  :class="
                    routeName == 'trust.immoveable-property.attachment'
                      ? 'active'
                      : ''
                  "
                  :to="{
