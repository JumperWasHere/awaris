  ...
  methods: {
    async getlistHibah() {
      ...
      if (this.userRole == "Staff") {
        query = `/hibah?status=${this.form.status}&except_status=-1&organization_id=${this.organization_id}&organization_type=${this.form.organization_type}&hibah_type=${this.form.hibah_type}&ic_number=${this.form.ic_number}&load_with=user,userDetail,organization,agent&limit=${this.pagination.perPage}&page=${this.pagination.currentPage}`;
      } else if (this.userRole == "Agent") {
        query = `/hibah?status=${this.form.status}&except_status=-1&organization_id=${this.organization_id}&organization_type=${this.form.organization_type}&hibah_type=${this.form.hibah_type}&ic_number=${this.form.ic_number}&agent_id=${this.currentUser.id}&load_with=user,userDetail,organization,agent&limit=${this.pagination.perPage}&page=${this.pagination.currentPage}`;
      } else if (this.userRole == "Super Admin") {
        query = `/hibah?status=${this.form.status}&except_status=-1&organization_id=${this.organization_id}&organization_type=${this.form.organization_type}&hibah_type=${this.form.hibah_type}&ic_number=${this.form.ic_number}&load_with=user,userDetail,organization,agent&limit=${this.pagination.perPage}&page=${this.pagination.currentPage}`;
      } else if (this.userRole == "Admin") {
        query = `/hibah?status=${this.form.status}&except_status=-1&&organization_type=${this.form.organization_type}&hibah_type=${this.form.hibah_type}&ic_number=${this.form.ic_number}&branch_id=${this.userAccess.id}&load_with=user,userDetail,organization,agent&limit=${this.pagination.perPage}&page=${this.pagination.currentPage}`;
      }
      // `/hibah?organization_id=${this.organization_id}&branch_id=${this.branch_id}&status=${this.status}&load_with=user,userDetail,organization,branch&limit=${this.pagination.perPage}&page=${this.pagination.currentPage}`;

      ApiService.get(
        query
        // `/hibah?load_with=user,userDetail,organization`
      )
        .then((response) => {
