...
export default {
  ...
  methods: {
    ...
    pushRedirectOneCent(hibah_typeID) {
  ...
  <div>
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="row">
          <div
            class="col-md-6 offset-md-3 mt-4 pt-2"
            v-if="userRole == 'Client'"
          >
            <div @click="pushRedirect(12)">
              <div class="card rounded shadow bg-dark border-0">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
                      <h4 class="text-white">Hibah One Cent</h4>
                      <div class="mt-4">
                        <p class="h6 text-muted mb-0">
                          Informasi Deklarasi Hibah One Cent Disini
                        </p>
                      </div>
                    </div>
            ...
            <div @click="pushRedirect(14)">
              <div class="card rounded shadow bg-dark border-0">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
                      <h4 class="text-white">Amanah Harta Pusaka</h4>
                      <div class="mt-4">
                        <p class="h6 text-muted mb-0">
                          Informasi Amanah Harta Pusaka Disini
                        </p>
                      </div>
                    </div>
                    <button class="btn btn-primary btn-sm">
