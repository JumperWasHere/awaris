...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      this.moveableProperty.moveable_id = this.hibahId;
  ...
  computed: {
    ...mapGetters(["userAccess", "userRole", "hibah", "preference"]),
    amendmentId() {
    ...
    setMoveableArray() {
      console.log("hibah_type:", this.hibah);
      return [
  ...
  <div class="col-lg-8 col-md-8 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
    <div class="row">
      ...
      <div class="col-lg-12 col-12 mb-4 pb-2 mt-3">
        ...
        >
          <div class="card-body">
            <h5 class="text-center">Maklumat Harta</h5>
            ...
            <div class="row mt-4">
              <div class="col-md-7">
                ...
                <div
                  class="form-group"
                  v-if="['1', '2'].includes(hibah.hibah_type)"
                >
          ...
          <div class="" v-if="moveableProperty.property_type == 'Saham'">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <label v-if="!['1', '2'].includes(hibah.hibah_type)">
                  {{ $t("accmembership-no") }}
                </label>
                <input
                  type="text"
