  ...
  <div class="col-lg-8 col-md-8 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
    <div class="row">
      <div class="col-md-12" v-if="message == 'saved'">
        <div class="alert alert-success">Harta alih telah berjaya disimpan</div>
      </div>
      <div class="col-md-12">
        <router-link
            ...
            <ul class="nav nav-tabs mt-4">
              <li class="nav-item">
                <router-link
                  class="nav-link"
                  :class="
                    routeName == 'trust-onecent.immoveable-property.details'
                      ? 'active'
                      : ''
                  "
                  :to="{
              ...
              <li class="nav-item">
                <router-link
                  class="nav-link"
                  :class="
                    routeName == 'trust-onecent.immoveable-property.receiver'
                      ? 'active'
                      : ''
                  "
                  :to="{
              ...
              <li class="nav-item">
                <router-link
                  class="nav-link"
                  :class="
                    routeName == 'trust-onecent.immoveable-property.attachment'
                      ? 'active'
                      : ''
                  "
                  :to="{
