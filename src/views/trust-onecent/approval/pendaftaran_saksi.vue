...
export default {
  ...
  methods: {
    async getOrgBankType() {
      ApiService.get(`/hibah/pending-approval?type=Bank&status=4`)
        .then((response) => {
    ...
    async getOrgKerajaanType() {
      ApiService.get(`/hibah/pending-approval?type=Kerajaan&status=4`)
        .then((response) => {
    ...
    async getOrgSwastaType() {
      ApiService.get(`/hibah/pending-approval?type=Swasta&status=4`)
        .then((response) => {
    ...
    async getOrgIndividualType() {
      ApiService.get(`/hibah/pending-approval?type=Individu&status=4`)
        .then((response) => {
    ...
    async getAwarisType() {
      ApiService.get(`/hibah/pending-approval?type=Awaris&status=4`)
        .then((response) => {
    ...
    async getOrgKoperasiType() {
      ApiService.get(`/hibah/pending-approval?type=Koperasi&status=4`)
        .then((response) => {
    ...
    async getOrgPelangganType() {
      ApiService.get(`/hibah/pending-approval?type=Pelanggan&status=4`)
        .then((response) => {
    ...
    >
      <div class="card-body">
        <h5 class="text-center" style="text-transform: uppercase">
          <!-- {{ $t("verifywasiat.list") }} -->
          SENARAI PENGESAHAN SAKSI HIBAH
        </h5>
        <div
